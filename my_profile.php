	...
	<div id="menu-profile">
		...
		<ul>
			...
			?>
				...
				<li>
					<a <?php if($module == "top_up"){ echo "class='active'"; } ?> href="<?php echo BASE_URL."index.php?page=my_profile&module=topup&action=list"; ?>">Top-Up</a>
				</li>
				<li>
			...
			?>	
				<li>
					<a <?php if($module == "wallet"){ echo "class='active'"; } ?> href="<?php echo BASE_URL."index.php?page=my_profile&module=wallet&action=list"; ?>">wallet</a>
				</li>
				<li>
					<a <?php if($module == "barang"){ echo "class='active'"; } ?> href="<?php echo BASE_URL."index.php?page=my_profile&module=barang&action=list"; ?>">Barang</a>
				</li>
			...
			?>
				<li>
					<a <?php if($module == "pesanan"){ echo "class='active'"; } ?> href="<?php echo BASE_URL."index.php?page=my_profile&module=pesanan&action=list_courier"; ?>">Pesanan</a>
				</li>	
				<?php
				}
			?>
